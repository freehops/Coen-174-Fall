        ...
        <div className="">
            ...
            <div className="bg-gray-400 py-[11.719vw]">
                ...
                <div className="flex justify-center mt-[4.668vw]">
                    <button className="bg-black text-[2.118vw] px-[3.125vw] p-[0.313vw] rounded-lg text-white">Start!</button>
                </div>
            </div>
            <div className="py-[3.906vw] mx-[3.906vw]">
                ...
                <div className="grid grid-cols-3 justify-items-center gap-x-[3.906vw] gap-y-[2.334vw]">
                        <img className="w-[27.5vw] h-[16.25vw]" src={boygirl}/>
                        <img className="w-[27.5vw] h-[16.25vw]" src={phone}/>
                        <img className="w-[27.5vw] h-[16.25vw]" src={manwoman}/>
